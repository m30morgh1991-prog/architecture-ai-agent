...
def runtime(status="READY_FOR_APPROVAL", contracts="VALID", semantics="ACCESSIBLE"):
    return {"status":status,"blockers":[],"contracts":{"status":contracts,"constraint_map_id":"cm-1"},"semantic_corroboration":{"status":semantics},"constraint_map":{"map_id":"cm-1"},"evidence":{"evidence_id":"ev-1","complete":True,"source_sha256":"src-1"},"source":{"sha256":"src-1"}}
