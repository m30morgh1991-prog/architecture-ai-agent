...
class E2ETests(unittest.TestCase):
    def make(self):
        ...
        orch = ExecutionOrchestrator(
            router, [ProviderCapability("p", frozenset({"interpret"}))]
        )
    ...
    def test_full_boundary_requires_approval_and_executes(self):
        ...
        self.assertEqual(r.release.status, "PASS")
    ...
    def test_unapproved_plan_is_blocked_before_execute(self):
        ...
        result = E2ERuntimeBoundary(visual, execute).run(
            "e2e-2", {}, "plan.png", {"status": "PROPOSED"}, {}
        )
